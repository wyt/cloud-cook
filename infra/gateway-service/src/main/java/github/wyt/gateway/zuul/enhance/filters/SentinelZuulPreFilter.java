...
public class SentinelZuulPreFilter extends ZuulFilter {
    ...
    public Object run() {
        ...
        try {
            ...
            ZuulBlockFallbackProvider zuulBlockFallbackProvider = (ZuulBlockFallbackProvider) ZuulBlockFallbackManager.getFallbackProvider(
                fallBackRoute);
            BlockResponse blockResponse = zuulBlockFallbackProvider.fallbackResponse(ctx.getRequest(), fallBackRoute, ex);
